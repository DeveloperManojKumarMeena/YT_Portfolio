  ...
  return (
   <footer className="relative overflow-hidden bg-black">
    ...
    >
      ...
      style={{fontSize:"clamp(3rem, 5vw, 14rem)" , letterSpacing:"0.02em" , lineHeight:"0.9" , padding:"0 3vw", whiteSpace:"nowrap" , textShadow:"0 2px 18px rgba(0,0,0,0.45) "}}>Manoj Kumar
      </h1>
      <div className="h-[3px] w-24  md:w-32 rounded-full bg-gradient-to-r from-[#0d58cc] via-cyan-300 to-emerald-400 "/>

      <div className="flex gap-5 text-2xl md:text-3xl">
        {socialLinks.map((s,i)=>{
            return<motion.a href={s.link} key={i} aria-label={s.label} target="_blank" rel='noopener noreferrer'
